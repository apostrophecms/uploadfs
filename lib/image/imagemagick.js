    ...
    convert: function(context, callback) {
      ...
      function convertSvg(context, callback) {
        ...
        function both() {
          ...
          console.log('both', xScaleFactor, yScaleFactor, viewport, viewbox, context.crop);
          
          // translate viewport selection to viewbox coordinates
          var _minX = context.crop.left / xScaleFactor;
          var _minY = context.crop.right / yScaleFactor;
          var _width = (context.crop.width + context.crop.left) / xScaleFactor;
          var _height = (context.crop.height + context.crop.top) / yScaleFactor
          ;
          var translatedViewbox = [_minX, minY, _width, _height];
