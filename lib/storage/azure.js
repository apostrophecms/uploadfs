...
module.exports = function() {
  ...
  var self = {
    ...
    copyIn: function(localPath, path, options, callback) {
      ...
      blobSvc.createBlockBlobFromLocalFile(container, path, localPath, function(error, result, response) {
        if (error) {
    ...
    remove: function(path, callback) {
      ...
      blobSvc.deleteBlobIfExists(container, path, {deleteSnapshots: BLOB_AND_SNAPSHOTS}, function(error, result, response) {
        if (error) {
