...
module.exports = function() {
  ...
  var self = {
    ...
    getGzipBlacklist: function(gzipEncoding) {
      var defaultGzipBlacklist  = ['jpg', 'png', 'zip', 'png', 'xls', 'docx', 'gif'];
      var { whitelist, blacklist } = Object.keys(gzipEncoding).reduce((prev, key) => { 
        if (foo[key]) {
      ...
      return ['jpg','etc'];
      //return _.uniq(defaultGzipBlacklist.concat(blacklist))
    },
  };
