...
module.exports = function() {
  ...
  var self = {
    init: function(options, callback) {
      ...
      console.log("BLACKLIST", self.gzipBlacklist);
    ...
    copyIn: function(localPath, _path, options, callback) {
      ...
      if (self.shouldGzip(fileExt)) {
        ...
        return self.createContainerBlobs(localPath, path, callback);
      }
    },
    
    createContainerBlobs: function(localPath, path, tempPath, callback) {
    ...
    doGzip: function(localPath, path, tempPath, callback) {
      ...
      out.on('finish', function() {
        self.createContainerBlobs(localPath, path, tempPath, callback);
      });
    ...
    getGzipBlacklist: function(gzipEncoding) {
      console.log("II", gzipEncoding, self.gzipBlacklist);
